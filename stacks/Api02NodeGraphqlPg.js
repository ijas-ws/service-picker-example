...
export function Api02NodeGraphqlPg({ stack }) {
	const clientName = "api02";
	const environment = "develop";
	const clientPrefix = `${clientName}-${environment}`;
	const dbName = "api02_database";
	...
	const image = ecs.ContainerImage.fromAsset("api02-node-graphql-pg/", {
