...
export function Api2NodeGraphqlMysql({ stack }) {
	const clientName = "api2";
	const environment = "develop";
	const clientPrefix = `${clientName}-${environment}`;
	const dbName = "api2_database";
	...
	const image = ecs.ContainerImage.fromAsset("api2-node-graphql-mysql/", {
